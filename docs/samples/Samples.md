...
We have provided some agent examples.

These agents were developed completely within the EBA lab tools. For each agent, we have provided the yaml configuration which you load into your own sandbox and review. In addition, we have provided development notes to help introduce you to the features available in EBA.

[Walmart trends](#walmart-trend) - gets trending products from Walmart.  
*topics:* external api, settings configuration, UI assets, collaborative reasoning.

[Riddles](#riddle-sample) - take over agent for asking riddles.  
...
[EDI sample](#EDI) - models inspection operations and a small submission process for objects within the Electronic Data Interchange.  
